...
try {
  ...
  python -m unittest test_core.py test_instagram_fallback.py test_desktop_extras.py test_windows_updater.py test_compact_post_panel.py test_xhs_search.py -v
  python -m py_compile app.py app_enhanced.py app_compact.py app_workspace.py core.py desktop_extras.py instagram_fallback.py instagram_runtime_hook.py windows_updater.py xhs_search.py make_windows_resources.py
