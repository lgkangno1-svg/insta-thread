...
try {
  ...
  python -m py_compile app.py app_enhanced.py app_compact.py core.py desktop_extras.py instagram_fallback.py instagram_runtime_hook.py make_windows_resources.py
